...
//     auto snakeBuf =
//         DCTL::CreateSnake(builder, s.playerId, tail, dir, &colorF);
//     snakes_vector.push_back(snakeBuf);
//   }

//   auto snakesBuf = builder.CreateVector(snakes_vector);

//   auto gameState = DCTL::CreateGameState(builder, sequence, snakesBuf);
...
//     Snake tmp;
//     // std::chrono::milliseconds dur(game_state->sequence snakesVec->Get(i)->time_stamp());
